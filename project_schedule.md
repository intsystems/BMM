...
### 19.10
* Technical meeting 2
* The benchmark is discussed
* The drafty version of the blogpost is discussed
* The drafty version of the tech. report is discussed
* The structure and drafty version of documentation is discussed

### 18.11
Checkpoint:
* Briefly discuss implemented algorithms

### 2.12
* Technical meeting 3
* The algorithms are discussed
* The demo is discussed
* The tests are discussed
* All the materials must be ready to review
